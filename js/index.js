...
if ($('.product__slider-main').length) {
  ...
  var $slider2 = $('.product__slider-thmb')
    ...
    .slick({
      ...
      dots: false,
      centerMode: false,
      prevArrow: '<img class="service_left" src="images/left_projectarrow.png" style="display: block;top: 20px;left: -8px;width: 25px;height: 25px;">',
      nextArrow: '<img class="service_right" src="images/right_projectarrow.png" style="display: block;top: 20px;right: -15px;width: 25px;height: 25px;">',
      focusOnSelect: true
    });
